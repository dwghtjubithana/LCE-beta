...
Route::middleware('jwt')->group(function () {
    ...
    Route::middleware('admin.role')->group(function () {
        ...
        Route::get('admin/settings/scanner-health', [AdminSettingsController::class, 'scannerHealth']);
        Route::get('admin/auth-providers', [AdminAuthProvidersController::class, 'show']);
        Route::get('admin/auth-providers/diagnostics', [AdminAuthProvidersController::class, 'diagnostics']);
